...
export function ResultsPipelineStrip({ stages }: { stages: string[] }) {
  ...
  return (
    <div
      className="flex flex-wrap items-center gap-x-1 gap-y-2 rounded-xl border border-border/80 bg-muted/40 px-3 py-2.5 md:justify-end md:rounded-2xl md:px-4"
