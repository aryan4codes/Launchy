    ...
    <div className="min-h-full overflow-hidden bg-[#fdf7ee] font-sans text-foreground antialiased dark:bg-background">
      ...
      <header className="relative z-30 mx-auto flex max-w-7xl items-center justify-between px-4 py-5">
        ...
        <div className="flex items-center gap-2">
          ...
          <Link
            to="/studio"
            className="hidden h-9 items-center justify-center rounded-full border border-zinc-200 bg-white/90 px-4 text-sm font-semibold text-zinc-900 shadow-sm backdrop-blur transition hover:bg-white sm:inline-flex"
          >
            Studio
          </Link>
        </div>
          ...
          <StaggerReveal className="mt-12 grid gap-6 lg:grid-cols-2" stagger={0.12} amount={0.15}>
              ...
              <div className="relative">
                ...
                <div className="mt-8 grid gap-3 sm:grid-cols-2">
                  {[
                    ...
                    <div
                      key={label}
                      className={`flex items-center gap-3 rounded-2xl border border-white/70 bg-gradient-to-br ${tint} px-3 py-3 text-sm font-semibold text-zinc-900 shadow-sm`}
                    >
            ...
            >
              ...
              <div className="relative">
                ...
                <div className="mt-8 rounded-2xl border border-white/70 bg-white/85 p-3 shadow-sm">
                  <div className="grid grid-cols-4 gap-2">
                    {[
                      ...
                      <span key={index} className={`flex h-12 items-center justify-center rounded-xl bg-gradient-to-br ${tint}`}>
